...
var getCleanPasswords = require('./unmunger/getCleanPasswords.cjs');
 ...
 * -------------------------------------------------------------------------------
 */
class MatchL33t extends matching {
